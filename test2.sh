...
# CRITICAL FIX: Pipe output through 'tr -d' to remove any line breaks added by the 'base64' utility.
CREDENTIALS_BASE64=$(echo -n "$KROGER_CLIENT_ID:$KROGER_CLIENT_SECRET" | base64 | tr -d '\n\r')

echo "Requesting new Access Token..."

# --- DEBUG CHECK ---
echo "DEBUG: Generated Base64 String:"
